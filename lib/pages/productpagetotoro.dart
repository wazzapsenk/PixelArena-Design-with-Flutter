...
import 'package:odev4/downloadPage/downtotoro.dart';
import 'package:odev4/productspecs.dart';
import 'package:odev4/colors.dart';

class ProductPageTotoro extends StatefulWidget {
  ProductSpecs specs;

  ProductPageTotoro({required this.specs});
  @override
  State<ProductPageTotoro> createState() => _ProductPageTotoroState();
}

class _ProductPageTotoroState extends State<ProductPageTotoro> {
  @override
      ...
      body: SingleChildScrollView(
        child: Center(
          child: Column(mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              Text(d!.totoroTitle, style: TextStyle(color: mainColor1,fontSize: 34,fontFamily: "Silkscreen",), ),
              Stack(children: [
                      ...
                      TextButton(onPressed: (){
                        ...
                        setState(() {
                          ...
                          Navigator.pushReplacement(context, //pushReplacement: bu sayfayı BagStack yığınından kaldırır
                              MaterialPageRoute(builder: (context)=> TotoroDownloadPage(specs: specs))); //context: buradaki sayfaya ait olduğunu belirtir

...
class ProductPageSpaceX extends StatefulWidget {
  ProductSpecs specs;

  ProductPageSpaceX({required this.specs});

  @override
  State<ProductPageSpaceX> createState() => _ProductPageSpaceXState();
}

class _ProductPageSpaceXState extends State<ProductPageSpaceX> {
      ...
      body: SingleChildScrollView(
        child: Center(
          child: Column(mainAxisAlignment: MainAxisAlignment.spaceEvenly,
            children: [
              Text(d!.spacexTitle, style: TextStyle(color: mainColor1,fontSize: 34,fontFamily: "Silkscreen",), ),
              Stack(children: [
                      ...
                      TextButton(onPressed: (){
                        setState(() {
                          ...
                          Navigator.pushReplacement(context, //pushReplacement: bu sayfayı BagStack yığınından kaldırır
                              MaterialPageRoute(builder: (context)=> SpaceXDownloadPage(specs: specs))); //context: buradaki sayfaya ait olduğunu belirtir
